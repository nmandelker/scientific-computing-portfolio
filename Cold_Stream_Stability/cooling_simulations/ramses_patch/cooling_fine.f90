...
subroutine coolfine1(ind_grid,ngrid,ilevel)
  ...
  do ind=1,twotondim
     ...
     if(cooling)then
        ...
        call solve_cooling(nH,T2,Zsolar,boost,dtcool,delta_T2,nleaf,Tmax_cool/0.5885) ! Nir Mandelker 4/9/17: 0.5885 is mu for T>5x10^4, n~10^{-4} and Z=0.01, with H&M UVB at z=2
     endif
