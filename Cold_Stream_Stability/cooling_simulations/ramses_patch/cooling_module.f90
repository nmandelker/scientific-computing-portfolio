...
!=======================================================================
subroutine solve_cooling(nH,T2,zsolar,boost,dt,deltaT2,ncell,T2_max_cool)
!=======================================================================
!Edited Nir Mandelker Sep 4 2017 to add cooling ceiling, T2_max_cool
  implicit none  
  integer::ncell
  real(kind=8)::dt,T2_max_cool
  ...
  real(kind=8)::lambda,lambda_prime,logT2max,logT2max2
  ...
  do while(n>0)
     ...
     do i=1,n
        ...
        if(facT.le.logT2max2.and.fact.le.logT2max)then
        ...
        elseif(facT.le.logT2max2.and.fact.gt.logT2max)then

           lambda=1.42*1d-27*sqrt(tau(ind(i)))*1.1
           lambda_prime=lambda/2./tau(ind(i))
        elseif(facT.gt.logT2max2)then
